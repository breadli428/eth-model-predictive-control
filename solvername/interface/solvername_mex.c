/*
 This is an interface for solvername that is used by optimizerFORCES to call the solver
*/ 
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) {
	...
	if( !mxIsCell(param_values) ) {
		mexErrMsgTxt("solvername requires a cell array as input.");
	}
	...
	copyMArrayToC(mxGetPr(par),params.T0,3);
